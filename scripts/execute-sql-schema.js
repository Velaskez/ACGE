...
async function executeSqlSchema() {
  try {
    ...
    try {
      await prisma.$executeRawUnsafe('CREATE UNIQUE INDEX IF NOT EXISTS "postes_comptables_numero_key" ON "postes_comptables"("numero")');
    ...
    try {
      await prisma.$executeRawUnsafe('CREATE UNIQUE INDEX IF NOT EXISTS "natures_documents_numero_key" ON "natures_documents"("numero")');
    ...
    try {
      await prisma.$executeRawUnsafe('CREATE UNIQUE INDEX IF NOT EXISTS "dossiers_numeroDossier_key" ON "dossiers"("numeroDossier")');
    ...
    try {
      await prisma.$executeRawUnsafe('ALTER TABLE "user_settings" ADD CONSTRAINT "user_settings_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE');
    ...
    try {
      await prisma.$executeRawUnsafe('ALTER TABLE "dossiers" ADD CONSTRAINT "dossiers_posteComptableId_fkey" FOREIGN KEY ("posteComptableId") REFERENCES "postes_comptables"("id") ON DELETE RESTRICT ON UPDATE CASCADE');
    ...
    try {
      await prisma.$executeRawUnsafe('ALTER TABLE "dossiers" ADD CONSTRAINT "dossiers_natureDocumentId_fkey" FOREIGN KEY ("natureDocumentId") REFERENCES "natures_documents"("id") ON DELETE RESTRICT ON UPDATE CASCADE');
    ...
    try {
      await prisma.$executeRawUnsafe('ALTER TABLE "dossiers" ADD CONSTRAINT "dossiers_secretaireId_fkey" FOREIGN KEY ("secretaireId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE');
    ...
    try {
      await prisma.$executeRawUnsafe('ALTER TABLE "validations_dossiers" ADD CONSTRAINT "validations_dossiers_dossierId_fkey" FOREIGN KEY ("dossierId") REFERENCES "dossiers"("id") ON DELETE CASCADE ON UPDATE CASCADE');
    ...
    try {
      await prisma.$executeRawUnsafe('ALTER TABLE "validations_dossiers" ADD CONSTRAINT "validations_dossiers_validateurId_fkey" FOREIGN KEY ("validateurId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE');
